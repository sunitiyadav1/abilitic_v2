...
class __Mustache_bdf16531e3f27cbcc8ed99c204a4e483 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<li class="user_notif ccn-settings-nav ccn-settings-nav-notif">
';
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            $buffer .= $this->section099a071c62a2edf254ba17d36b2296a0($context, $indent, $value);
        }
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
...
';
    ...
    private function section099a071c62a2edf254ba17d36b2296a0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '">
';
                $buffer .= $indent . '            <div class="ccn--popover-region-footer-container">
';
