...
class __Mustache_c838943665be3bac08c6d5d4d55cbf7a extends Mustache_Template
{
...
';
        $buffer .= $indent . '            class="btn w-100 text-left p-3 d-flex align-items-center overview-section-toggle ';
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_lazy_load_list')) {
            $context->pushBlockContext(array(
                'rootclasses' => array($this, 'blockFed40d8ecae03f5e38b53d9a9af39916'),
...
';
    ...
    public function blockFed40d8ecae03f5e38b53d9a9af39916($context)
    {
        $indent = $buffer = '';
        $buffer .= 'collapse ';
        // 'expanded' section
