...
class __Mustache_52796a93870c696da1f15b641737e3fc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="hidden px-2 py-3" aria-hidden="true" data-region="view-contacts">
';
        $buffer .= $indent . '    <div class="d-flex align-items-center">
';
        // 'isdrawer' section
        $value = $context->find('isdrawer');
        $buffer .= $this->sectionE4a4837998097fd1deecb162ec088d47($context, $indent, $value);
        $buffer .= $indent . '        <div>
';
        $buffer .= $indent . '            ';
        // 'str' section
...
';
    ...
    private function sectionE4a4837998097fd1deecb162ec088d47(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
