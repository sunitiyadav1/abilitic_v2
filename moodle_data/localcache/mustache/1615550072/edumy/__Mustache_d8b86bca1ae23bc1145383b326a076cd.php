...
class __Mustache_d8b86bca1ae23bc1145383b326a076cd extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="content-message-container hidden" data-region="content-message-container" role="log">
';
        $buffer .= $indent . '            <div class="py-3 bg-light sticky-top z-index-1 border-bottom text-center hidden" data-region="contact-request-sent-message-container">
';
...
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="p-3 bg-light text-center hidden" data-region="self-conversation-message-container">
';
        $buffer .= $indent . '                <p class="m-0">';
        // 'str' section
        $value = $context->find('str');
