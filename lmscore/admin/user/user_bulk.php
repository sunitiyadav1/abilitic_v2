...
$dc   = optional_param('dc', '0', PARAM_INT);

/* 
* @author     : Suniti Yadav 
* description : If its a part of dynamic cohort then it should redirect to our custom page.
*/

if($dc == 1)
{
    //SY
    redirect($CFG->wwwroot.'/'.$CFG->admin.'/user/custom_user_bulk_cohort.php?m=d');
    exit();
}
