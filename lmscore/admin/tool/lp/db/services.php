...
$functions = array(
    ...
    ),/* Suniti Yadav - Learning Plan - core_enrol_get_users_lp_courses API */
    'core_enrol_get_users_lp_courses' => array(
        'classname' => 'core_enrol_external',
        'methodname' => 'get_users_lp_courses',
        'classpath' => 'enrol/externallib.php',
        'description' => 'Get the list of courses which is in learning plan',
        'type' => 'read',
