...
$PAGE->set_url('/customconfig/cohort/user/v1/dynamic_cohort.php');
...
$PAGE->navbar->add('Dynamic Cohorts - u:v1', new moodle_url('/customconfig/cohort/user/v1/dynamic_cohort.php'));
echo $OUTPUT->header();
...
<html>
    ...
    <body>
    	<a href="<?php echo $CFG->wwwroot.'/customconfig/cohort/user/v1/set_dc_rule.php'; ?>"><button type="button" id="clone_btn" class="btn btn-primary">Create New Rule Set</button></a>
    	<br><br>
...
<script type="text/javascript">
	$(document).ready(function (){ 
	    var loc = "<?php echo $CFG->wwwroot.'/customconfig/cohort/user/v1/get_dynamic_cohort.php'; ?>";  
