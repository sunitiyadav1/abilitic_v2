...
$PAGE->set_url('/customconfig/cohort/user/v2/set_dc_rule.php');

$table = new table_sql('uniqueid');
// Print the page header
$PAGE->set_title($CFG->app_name);
$PAGE->set_heading('Add Rule Set');
$PAGE->navbar->add('Add Rule Set', new moodle_url('/customconfig/cohort/user/v2/set_dc_rule.php'));
echo $OUTPUT->header();
...
<html>
   <?php require "default_structure.php"; ?>
    <body>
    	...
    	<a href="<?php echo $CFG->wwwroot.'/customconfig/cohort/user/v2/dynamic_cohort.php'; ?>" style="float: right;">
