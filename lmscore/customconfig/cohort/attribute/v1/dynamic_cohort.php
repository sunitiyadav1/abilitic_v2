...
$PAGE->set_url('/customconfig/cohort/attribute/v1/dynamic_cohort.php');
...
$PAGE->navbar->add('Dynamic Cohort - a:v1', new moodle_url('/customconfig/cohort/attribute/v1/dynamic_cohort.php'));
echo $OUTPUT->header();
...
<html>
    ...
    <body>
    	<a href="<?php echo $CFG->wwwroot.'/customconfig/cohort/attribute/v1/set_dc_rule.php'; ?>">
...
<script type="text/javascript">
	$(document).ready(function (){ 
	    var loc = "<?php echo $CFG->wwwroot.'/customconfig/cohort/attribute/v1/get_dynamic_cohort.php'; ?>";  
	    ...
	    $('#frm-example').on('submit', function(e){
	      	...
	      	//console.log("Form submission", $(form).serialize()); 
	       	...
	       	$.each($("input[name='id']:checked"), function(){
                ...
                var loc_url    = "<?php echo $CFG->wwwroot.'/customconfig/cohort/attribute/v1/dc_api.php'; ?>";
        ...
        */
	    ...
	    $('#example').on('click', '.delete', function (e) {
	    	...
	    	var set_url 	= "<?php echo $CFG->wwwroot.'/customconfig/cohort/attribute/v1/dc_api.php'; ?>";
