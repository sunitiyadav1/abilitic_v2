...
$get_columns 	= $DB->get_records_sql("SELECT * FROM `mdl_custom_user_bulk_field_detail` where is_visible = '1' order by field");

$context = context_system::instance();
$PAGE->set_context($context);
$PAGE->set_url('/customconfig/cohort/user_bulk/v1/set_dc_rule.php');

$table = new table_sql('uniqueid');
// Print the page header
$PAGE->set_title($CFG->app_name);
$PAGE->set_heading('Add Rule Set');
$PAGE->navbar->add('Add Rule Set', new moodle_url('/customconfig/cohort/user_bulk/v1/set_dc_rule.php'));
echo $OUTPUT->header();
...
<html>
   <?php require "default_structure.php"; ?>
    <body>
    	...
    	<a href="<?php echo $CFG->wwwroot.'/customconfig/cohort/user_bulk/v1/dynamic_cohort.php'; ?>" style="float: right;">
