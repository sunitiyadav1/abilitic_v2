...
/**
 * @author        Suniti Yadav
 * @description   Script to dynamically set cohort members.
 */
...
$get_rule_set = $DB->get_records_sql("SELECT * FROM `mdl_dynamic_cohort_cust_rule_set` where is_active = 1 and is_deleted = 0");
...
$rec_insert1->name  	    = "Dynamic Cohort Version 2 - Enhancement";
