...
class core_enrol_external extends external_api {
     ...
     * @return external_function_parameters
     */
    public static function get_users_lp_courses_parameters() {
        return new external_function_parameters(
            array(
    ...
    /* learning plan */
    public static function get_users_lp_courses($userid,$planid, $returnusercount = true) {
        global $CFG, $USER, $DB;
        ...
        $params = self::validate_parameters(self::get_users_lp_courses_parameters(),
                ['userid' => $userid, 'planid' => $planid, 'returnusercount' => $returnusercount]);
        $userid = $params['userid'];
        $planid = $params['planid'];
        $returnusercount = $params['returnusercount'];

        $courses = enrol_get_users_lp_courses($userid,$planid, true, '*');
        $result = array();
        ...
        foreach ($courses as $course) {
            ...
            /* // Here it validates that user should only see courses in which user is enrolled.
            try {
                self::validate_context($context);
            } catch (Exception $e) {
     ...
     */
    public static function get_users_lp_courses_returns() {
