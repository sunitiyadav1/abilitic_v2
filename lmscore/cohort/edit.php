...
$dc        = optional_param('dc', 0, PARAM_INT); // Added By - Suniti Yadav
...
if ($editform->is_cancelled()) {
    ...
    if ($data->id) {
        ...
        $dc = 1; // Added by Suniti Yadav
    }

    // Added by Suniti Yadav
    if($dc)
    {
        redirect(new moodle_url('/admin/user/custom_user_bulk_cohort.php', array('dc' => $dc, 'm' => 'ca')));
    }
