...
class mod_facetoface_user_form extends moodleform {
    ...
    //  $mform->addElement("html","<div>Cohort Size: </div>");
        $mform->addElement("static",'total_users1',get_string("total_users","facetoface"),array("id"=>"total_users1"));
     ...
     //die("her");
       $buttonarray=array();
       $buttonarray[] = $mform->createElement('submit', 'submitbutton1', get_string('add_attendees','facetoface'));
