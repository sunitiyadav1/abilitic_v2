...
class mod_facetoface_attributevalue_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement("html",'<div id="show_loader3" style="display:none;"><img src="./scripts/loader.gif" height="100px" width="100px"></div>
    ...
    <div class="alert alert-danger" role="alert" id="pmsgbodyerror3" style="display:none;">
      This is a danger alert—check it out!
        ...
        $mform->addElement("static",'total_users3',get_string("total_users","facetoface"),array("id"=>"total_users3"));
     ...
     /* $mform->addElement("html", '<!-- Modal -->
      ...
      $buttonarray=array();
      $buttonarray[] = $mform->createElement('submit', 'submitbutton3', get_string('add_attendees','facetoface'));
