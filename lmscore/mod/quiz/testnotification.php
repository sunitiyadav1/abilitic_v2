...
print_r($course_grade);die;
quiz_send_congratulation_messages($course, $quiz, $attempt, context_module::instance($cm->id), $cm);
/*
function quiz_send_congratulation_messages($course, $quiz, $attempt, $context, $cm) {
    global $CFG, $DB;
    ...
    $allok = true;
    $allok = $allok && quiz_send_congratulation($submitter, $a);
    return $allok;
}



function quiz_send_congratulation($recipient, $a){
    $mailcontent ="<p> Hi Kajal Tailor,<BR>

        Congratulations for submitting your answers to '".$a->quizname."' in course '".$a->coursename."' at ".$a->submissiontime.".<br>

        This message confirms that your answers have been saved and you <B>PASS</B> the Quiz Successfully.<BR><BR>
         
        Total Marks(Grade) : ".$a->grade ."<BR>
        Obtained Marks(Grade) :".$a->sumgrade."<br><BR>
