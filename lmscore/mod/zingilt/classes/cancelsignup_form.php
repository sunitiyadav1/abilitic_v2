...
class mod_zingilt_cancelsignup_form extends moodleform {

    public function definition() {
        $mform =& $this->_form;

        $mform->addElement('header', 'general', get_string('cancelbooking', 'zingilt'));
        ...
        $mform->addElement('html', get_string('cancellationconfirm', 'zingilt')); // Instructions.

        $mform->addElement('text', 'cancelreason', get_string('cancelreason', 'zingilt'), 'size="60" maxlength="255"');
